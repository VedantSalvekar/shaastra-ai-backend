...
def classify_intent(question: str, user_has_docs: bool) -> IntentType:
    """
    ...
    user_doc_keywords = [
        ...
        "my application", "my irp", "my permit"
    ]
    ...
    # ========== STEP 2: Use AI to classify more accurately ==========
...
Think step by step:
1. Does the question mention the user's specific documents? (keywords: "my", "my document", "my letter")
